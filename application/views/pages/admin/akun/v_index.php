    ...
    <!-- Basic initialization -->
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"><?php echo $menu; echo $sub_title == "Trash" ? ' - Data Sampah' : '';?> </h5>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($datatable as $row) {
                                            $bt = '<a href="'.site_url(current_group().'/'.$menu_alias."/edit/".$row->id).'" class="dropdown-item"><i class="icon-pencil5"></i> Edit</a>';
