                                        ...
                                        if($sub_title != "Trash"):
                                            $bt = '<div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="'.site_url(current_group().'/'.$menu_alias."/edit/".$row->postid).'" class="dropdown-item"><i class="icon-pencil5"></i> Edit</a>
                                                                <a href="#move" data-toggle="confirm-move" data-address="'.site_url(current_group().'/'.$menu_alias."/delete/".$row->postid).'" type="button" class="dropdown-item" ><i class="icon-trash-alt"></i> Move to Trash </a>
                                                            </div>
                                                        </div>
                                                    </div>';
                                            $trash_info = "";
                                            ...
                                            $bt = '<div class="list-icons">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="#recovery" data-toggle="confirm-recovery" data-address="'.site_url(current_group().'/'.$menu_alias."/recovery/".$row->postid).'" type="button" class="dropdown-item" ><i class="icon-undo2"></i> Kembalikan ke List Data </a>
                                                            <a href="#remove" data-toggle="confirm-remove" data-address="'.site_url(current_group().'/'.$menu_alias."/remove/".$row->postid).'" type="button" class="dropdown-item" ><i class="icon-cross3"></i> Remove </a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            $trash_info = "
