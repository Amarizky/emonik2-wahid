                                        ...
                                        if($sub_title != "Trash"):
                                            $bt = '<div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="'.site_url(current_group().'/'.$menu."/edit/".$row->menuid).'" class="dropdown-item"><i class="icon-pencil5"></i> Edit</a>
                                                                <a href="#move" data-toggle="confirm-move" data-address="'.site_url(current_group().'/'.$menu."/delete/".$row->menuid).'" type="button" class="dropdown-item" ><i class="icon-trash-alt"></i> Move to Trash </a>
                                                            </div>
                                                        </div>
                                                    </div>';
                                            $trash_info = "";
                                            ...
                                            $bt = '<div class="list-icons">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="#recovery" data-toggle="confirm-recovery" data-address="'.site_url(current_group().'/'.$menu."/recovery/".$row->menuid).'" type="button" class="dropdown-item" ><i class="icon-undo2"></i> Kembalikan ke List Data </a>
                                                            <a href="#remove" data-toggle="confirm-remove" data-address="'.site_url(current_group().'/'.$menu."/remove/".$row->menuid).'" type="button" class="dropdown-item" ><i class="icon-cross3"></i> Remove </a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            $trash_info = "
