        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item"><a href="<?php echo site_url(current_group().'/'.$menu.'/index');?>" class="nav-link " >List Data</a></li>
                    <li class="nav-item"><a href="<?php echo site_url(current_group().'/'.$menu.'/index/Add');?>" class="nav-link " >Add New</a></li>
