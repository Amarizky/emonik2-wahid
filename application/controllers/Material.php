...
class Material extends CI_Controller {
    ...
    public function index($page = 'List') {
        $data['title'] = "Upload Data Material";
        $data['sub_title'] = 'All Data';
        $data['menu'] = "Upload Data Material";
        ...
        // request data ke api
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://kahftekno.com/rest-emonikv2/index.php/apikomposisiproduk/listproduk');
